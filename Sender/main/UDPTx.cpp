...
udp_status_t UDPTx::sendData(const int16_t *tx_data, const size_t data_len)
{
...
void UDPTx::setupDestinationIP(uint32_t ip_address)
{
...
void UDPTx::udpEventHandler(void *arg, esp_event_base_t event_base,
                          int32_t event_id, void *event_data)
{
    UDPTx *self = (UDPTx *)arg;
...
int16_t UDPTx::calculateChecksum(const int16_t *tx_data)
{
    uint16_t sum = 0;
    int16_t checksum = 0;
